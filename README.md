# nvim-treesitter-queries-hlsl

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-hlsl/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-hlsl/actions/workflows/validate.yml)

Neovim tree-sitter queries for **hlsl**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-hlsl",
...
- [ ] Changes are scoped to `hlsl` — do not include files for other languages
